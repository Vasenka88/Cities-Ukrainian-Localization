...
Тут є два варіанти: через модифікацію та вручну. Вручну для тих, хто не хоче обтяжувати себе зайвими модами, але тут потрібно знати де локальні файли гри, адже кожна версія та система має своє розташування.
